  ...
  return (
    <div className="flex items-center justify-center py-20">
      ...
      <h2 className="text-4xl font-bold font-mono">😒404</h2>
        ...
        <Link to={"/"} className="bg-black text-slate-100 w-44 h-12 rounded-full text-base font-semibold hover:bg-fuchsia-600 hover:text-white duration-200 flex items-center justify-center">Back To Home</Link>
      </div>
    </div>
  );
};
